...
exports.CommissionModule = CommissionModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [commission_service_1.CommissionService, commission_calculator_service_1.CommissionCalculatorService],
        exports: [commission_service_1.CommissionService, commission_calculator_service_1.CommissionCalculatorService],
    })
], CommissionModule);
