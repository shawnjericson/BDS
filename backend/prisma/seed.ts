...
async function main() {
  ...
  // Hash password for test users (password: "123456")
  ...
  // Create sample bookings with prices
  const bookings = [
    {
      id: 1,
      productId: 1,
